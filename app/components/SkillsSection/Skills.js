      ...
      <div className="skills-type bg-stone-700 mx-20">
        ...
        <div className="programming-lang bg-zinc-800 p-5 my-10 mx-5 ">
          ...
          <div className="prolang  flex justify-start gap-20 mt-5">
            <div className="python p-5 flex flex-col items-center gap-2">
              <img
                className="w-[3rem]"
            ...
            <div className="java p-5 flex flex-col items-center gap-2">
              <img
                className="w-[4rem]"
            ...
            <div className="javascript p-5 flex flex-col items-center gap-2">
              <img
                className="w-[3rem]"
        ...
        <div className="programming-lang bg-zinc-800 p-5 my-10 mx-5 ">
          ...
          <div className="nodejs  flex justify-start gap-20 mt-5">
            <div className="python p-5 flex flex-col items-center gap-2">
              <img
                className="w-[3rem]"
                src="/skills/node 1.png"
                alt="loading.."
              />
              <p className="text-white text-lg font-semibold">Node Js</p>
            </div>
            <div className="express-js p-5 flex flex-col items-center gap-2">
              <img
                className="w-[4rem]"
            ...
            <div className="jwt-auth p-5 flex flex-col items-center gap-2">
              <img
                className="w-[3rem]"
        ...
        <div className="programming-lang bg-zinc-800 p-5 my-10 mx-5 ">
          ...
          <div className="prolang  flex justify-start gap-20 mt-5">
            ...
            <div className="mySQL p-5 flex flex-col items-center gap-2">
              <img
                className="w-[4rem]"
        ...
        <div className="programming-lang bg-zinc-800 p-5  mb-10 mx-5 ">
          ...
          <div className="prolang  flex justify-start gap-20 mt-5">
            ...
            <div className="canva p-5 flex flex-col items-center gap-2">
              <img
                className="w-[4rem]"
