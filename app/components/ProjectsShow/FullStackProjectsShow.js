...
const FullStackProjectsShow = () => {
  return (
    <div className="sub-container bg-slate-800 rounded-lg p-2 my-5 lg:my-10 lg:p-3 2xl:p-5 2xl:my-10 ">
      <div className="fullstack-projects-box">
        ...
        <div className="swiper-container hidden lg:block 2xl:block ">
          <Swiper
            slidesPerView={3}
            spaceBetween={30}
            freeMode={true}
